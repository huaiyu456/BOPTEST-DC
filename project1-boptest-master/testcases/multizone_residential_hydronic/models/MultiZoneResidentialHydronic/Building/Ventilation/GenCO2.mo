...
model GenCO2 "CO2 generation in a zone"
  ...
  parameter Modelica.Units.SI.MassFlowRate co2gen=0.004*1.8/1000
    "CO2 generation per person in KgCO2/(s*person)";
  parameter Modelica.Units.SI.DimensionlessRatio nOcc

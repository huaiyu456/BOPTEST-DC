...
model Boiler
  ...
  parameter Modelica.Units.SI.Power ConsoElec_Ventilateur=25
    "Boiler fan electic power "
    annotation (Dialog(group="Boiler characteristics"));
  parameter Modelica.Units.SI.Power ConsoElec_VannesGaz=7
    "Gas valvez electric power"
    annotation (Dialog(group="Boiler characteristics"));
  parameter Modelica.Units.SI.Power[5,2] ConsoElec_PompeCirculation=[0,0; 7/60,
      0; 9.65/60,63; 11.35/60,105; 12/60,105] "Heating pump electric power"
    annotation (Dialog(group="Boiler characteristics"));
  parameter Modelica.Units.SI.Power ConsoElec_PompeECS=45
    "DHW Pump electric power"
    annotation (Dialog(group="Boiler characteristics"));
  parameter Modelica.Units.SI.Power ConsoElec_Veille=4 "Standby electric power"
    annotation (Dialog(group="Boiler characteristics"));
...
//  Modelica.SIunits.Power QWat_flow "Heat transfer from gas into water";
  ...
  Modelica.Blocks.Tables.CombiTable1Dv combiTable1D(table=

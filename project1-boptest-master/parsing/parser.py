...
import sys
#sys.path.append(r'C:\Users\ASUS\pymodelica')
from pymodelica import compile_fmu
import os
import json
from data.data_manager import Data_Manager
import warnings
# 设置 JAVA_HOME 环境变量为正确的 Java 安装路径
os.environ['JAVA_HOME'] = r'C:\Program Files\Java\jre1.8.0_431'
if 'MODELICAPATH' in os.environ:
    modelicapath=os.environ['MODELICAPATH']
else:
    modelicapath=os.path.abspath(r'C:\Users\ASUS\.conda\envs\python27\Lib\site-packages\pymodelica')
